...
export const translations = {
  uz: {
    about: {
      ...
      authorSub: 'Full-stack Dasturchi va Dizayner',
      authorQuote: "\"Ushbu platforma O'zbekistondagi abituriyentlar uchun oliy ta'lim muassasalarini tanlash, kontrakt narxlari bilan tanishish va o'z imkoniyatlarini kalkulyator orqali hisoblashda yordam berish uchun yaratilgan shaxshiy loyihadir.\"",
      resultsBadge: 'Xulosa',
    ...
    footer: {
      tagline: 'University.uz',
      headline: "Talabalar uchun keyingi universitetlarini tanlashda yuqori darajadagi ko'mak.",
      description: "O'zbekistondagi ambitsiyali abituriyentlar uchun premium darajadagi kashfiyotlar, qabul yordami va zamonaviy akademik intellekt.",
      quickLinks: 'Tezkor Havolalar',
      socialMedia: 'Ijtimoiy Tarmoqlar',
      newsletter: 'Yangiliklar',
      newsletterDesc: "Qabul bo'yicha haftalik yangiliklar, grantlar va platforma tushunchalari.",
      subscribe: "Obuna bo'lish",
      placeholder: 'Elektron pochta',
      rights: '© 2026 University.uz. Barcha huquqlar himoyalangan.',
      builtFor: 'Premium qabul tajribasi uchun qurilgan.'
    },
    stats: {
  ...
  ru: {
    about: {
      ...
      authorSub: 'Full-stack Разработчик и Дизайнер',
      authorQuote: "\"Эта платформа - личный проект, созданный для того, чтобы помочь абитуриентам в Узбекистане выбрать вуз, ознакомиться с ценами на контракты и рассчитать свои возможности с помощью калькулятора.\"",
      resultsBadge: 'Итог',
    ...
    hero: {
      ...
      topDirections: [
        ...
        ['Ташкент', 'Искусственный интеллект', '94 балла тренда'],
        ['Навои', 'Логистика', '89 баллов тренда'],
        ['Андижан', 'Медицина', '91 балл тренда'],
      ],
    },
    footer: {
      tagline: 'University.uz',
      headline: 'Высококлассная помощь студентам в выборе их будущего университета.',
      description: 'Премиальное открытие, поддержка при поступлении и современный академический интеллект для амбициозных абитуриентов в Узбекистане.',
      quickLinks: 'Быстрые ссылки',
      socialMedia: 'Социальные сети',
      newsletter: 'Новостная рассылка',
      newsletterDesc: 'Еженедельные обновления о поступлении, гранты и релизы платформы.',
      subscribe: 'Подписаться',
      placeholder: 'Электронная почта',
      rights: '© 2026 University.uz. Все права защищены.',
      builtFor: 'Создано для премиального опыта поступления.'
    },    
    stats: {
